    ...
    <div
        ...
        <div class="text-center sm:text-left">
            <p
                ...
                tecnologías de la información, seguridad y automatización electrónica, asegurando <a href="#trabajos-destacados"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="w-full md:max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <p class=" text-gray-700 mt-2">¿Deseas mejorar la seguridad de tu hogar o negocio? Nuestro servicio de
