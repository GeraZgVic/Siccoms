...
<div
    ...
    <div class="pt-6 text-center mb-6 sm:mb-0 sm:mr-10 md:mr-20 lg:mr-24 xl:mr-32">
        <h2
            ...
            De la idea a la acción: haciendo realidad tus objetivos
        </h2>
    ...
    <div class="text-center sm:text-left">
        <p
            ...
            Con la experiencia y calidad de SICCOMS Tabasco, ofrecemos soluciones integrales en desarrollo de software, tecnologías de la información, seguridad y automatización electrónica, asegurando <span
                class="text-white hover:text-sky-300 border-b-2 border-b-gray-300 hover:border-b-sky-300">excelencia en cada proyecto,</span>
                Ven y contáctanos.
        </p>
    </div>
</div>
...
<div id="services" class="section relative pt-20 pb-8 md:pt-16 md:pb-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="w-full md:max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
                ...
                <div class="px-6 py-4">
                    ...
                    <p class=" text-gray-700 ">¿Quieres tener el control total de tus vehículos, SICCOMS Tabasco Te
            ...
            <div class="w-full md:max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
                ...
                <div class="px-6 py-4">
                    <h3 class="text-xl font-semibold text-gray-800">Instalaciones CCTV de Videovigilancia</h3>

                    <p class=" text-gray-700 ">¿Deseas mejorar la seguridad de tu hogar o negocio? Nuestro servicio de
            ...
            <div class="w-full md:max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
                ...
                <div class="px-6 py-4">
                    <h3 class="text-xl font-semibold text-gray-800">Servicios de Desarrollo Web y Sistemas a tu Medida
                    </h3>

                    <p class=" text-gray-700 ">¿Buscas una solución digital que se ajuste perfectamente a las
            ...
            <div class="w-full md:max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
                ...
                <div class="flex items-center px-6 py-3 bg-gray-900">
                    ...
                    <strong class="mx-3 text-lg font-semibold text-white">Alarmas </strong>
                </div>

                <div class="px-6 py-4">
                    <h3 class="text-xl font-semibold text-gray-800">Instalaciones de Alarmas Comerciales y Residenciales
                    </h3>

                    <p class=" text-gray-700 ">¿Quieres proteger tu hogar o negocio de posibles amenazas?
            ...
            <div class="w-full md:max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
                ...
                <div class="px-6 py-4">
                    <h3 class="text-xl font-semibold text-gray-800">Instalaciones de Controles de Acceso Vehicular
                    </h3>

                    <p class="text-gray-700 ">¿Necesitas gestionar de forma eficiente el acceso de vehículos a tu
            ...
            <div class="w-full md:max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
                ...
                <div class="px-6 py-4">
                    ...
                    <p class=" text-gray-700 ">¿Deseas proteger tu propiedad de intrusos de manera efectiva?
    ...
    <div class="my-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-2">
        <div class=" w-full overflow-hidden bg-white rounded-lg shadow-lg">
            ...
            <div class="px-6 py-4">
                <h3 class="text-xl font-semibold text-gray-800 2xl:text-3xl">SICCOMS, Conectando ideas, potenciando negocios: Tu socio en consultoría, comercialización y servicios integrales.</h3>
        ...
        <div class="md:col-span-1">
            <div class="px-4 py-6 bg-white rounded-lg shadow-md">
                ...
                <p class="text-base md:text-lg text-gray-700 mb-6">Descubre nuestra galería de fotos para conocer nuestros proyectos más destacados.</p>
            ...
            <div class="container flex flex-col items-start mx-auto lg:items-center">
                ...
                <div class="items-center justify-center w-full mt-12 mb-4 lg:flex">
                    <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                        ...
                        <blockquote class="mt-8 text-lg text-gray-600">"Esto es una obviedad si desea llevar su negocio
                            al
                    ...
                    <div
                        ...
                        <blockquote class="mt-8 text-lg text-gray-600">"Gracias por crear este servicio. Mi vida es
                            mucho
                    ...
                    <div class="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                        ...
                        <blockquote class="mt-8 text-lg text-gray-600">"Repleto de contenido increíble y exactamente lo
                            que
