...
@section('contenido')
 {{-- Clientes --}}
    ...
    <div class="pt-20 pb-8 md:pt-16 md:pb-0 ">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2 bg-white px-4 rounded-lg">
                    <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        alt="Main Article" class="w-full h-2/3 object-cover rounded-lg mb-6">
                    <div class="my-3">
                        <span
                            class="bg-green-500 py-1 px-2 rounded-full text-xs text-white font-medium uppercase leading-none">Tecnología</span>
                    </div>
                    <div class="mb-4 text-gray-600 text-sm">Jul 20, 2022</div>

                    <h3 class="text-2xl font-semibold mb-4">Consecutres Dummy Content Velit officia consequat duis enim
                        velit</h3>
                    <p class="text-gray-700">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.
                ...
                <div class="space-y-6">
                    <div class="bg-white p-4 rounded-lg">
                        <img src="https://images.unsplash.com/photo-1531297484001-80022131f5a1?q=80&w=2020&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="Article 1" class="w-full h-40 object-cover rounded-lg mb-4">
                        <div class="my-3">
                            <span
                                class="bg-green-500 py-1 px-2 rounded-full text-xs text-white font-medium uppercase leading-none">Tecnología</span>
                        </div>
                        <div class="mb-2 text-gray-600 text-sm">Jul 20, 2022</div>
                        <h4 class="font-semibold text-lg mb-2">Consectetures Content Velitpato officia consequat duis enim
                            velit mollit</h4>
                        <a href="#"
                            class="cursor-pointer flex items-center gap-2 text-lg text-indigo-700 font-semibold">
                            Leer más<svg width="15" height="12" viewBox="0 0 15 12" fill="none"
                    ...
                    <div class="bg-white p-4 rounded-lg">
                        <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8dGVjbm9sb2d5fGVufDB8fDB8fHww"
                            alt="Article 2" class="w-full h-40 object-cover rounded-lg mb-4">
                        <div class="my-3">
                            <span
                                class="bg-green-500 py-1 px-2 rounded-full text-xs text-white font-medium uppercase leading-none">Tecnología</span>
                        </div>
                    ...
                    <div class="bg-white p-4 rounded-lg">
                        <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="Article 3" class="w-full h-40 object-cover rounded-lg mb-4">
                        <div class="my-3">
                            <span
                                class="bg-green-500 py-1 px-2 rounded-full text-xs text-white font-medium uppercase leading-none">Tecnología</span>
                        </div>
