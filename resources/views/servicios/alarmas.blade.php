...
@section('contenido')
    <div class="text-center px-8 pt-24 pb-16 mx-auto md:px-12 lg:px-32 max-w-7xl">
        <h1 class="text-4xl font-semibold tracking-tighter text-gray-900 lg:text-5xl text-balance font-mulish-bold">
        ...
        <div class="relative h-full p-2 mt-24 overflow-hidden border rounded-3xl">
            <img src="{{ asset('img/hero-alarm.webp') }}" class="object-cover h-full border shadow-2xl rounded-2xl">
        </div>
    </div>
    <div class="bg-gradient-to-b from-black to-gray-800 py-24">
        <section class="px-8 mx-auto md:px-12 lg:px-32 max-w-7xl">
            <h2 class="text-3xl font-semibold tracking-tight py-2 lg:text-4xl text-center bg-gradient-to-r from-slate-200 to-neutral-400 bg-clip-text text-transparent font-mulish-bold">
