                ...
                <div class="pt-6">
                    <div class="flow-root px-6 pb-8 rounded-lg bg-gray-800 bg-opacity-60">
                        <div class="-mt-6">
                            ...
                            <p class="mt-5 text-base text-gray-300">Seguridad familiar y control de visitas. <br> Mantén tu espacio seguro</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div
                ...
                <div class="w-full lg:w-1/2">
                    <img src="https://images.unsplash.com/photo-1643123182527-3bd30840e7ed?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        ...
                        <div class="accordion-group" data-accordion="default-accordion">
                            ...
                            <div class="accordion py-8 border-b border-solid border-gray-200"
                                ...
                                <div id="faq-collapse-three"
                                    ...
                                    <p class="text-base text-gray-500 font-normal">
                                        Sí, ofrecemos servicios completos de instalación y configuración profesional para garantizar que su sistema CCTV esté optimizado y listo para funcionar desde el primer día.
                                    </p>
                                </div>
                            </div>
                        </div>
