...
@section('contenido')
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 py-12 h-[100vh]">
        <div>
            ...
            <section>
                <h2 class="text-2xl font-bold mb-4 text-gray-700 animate-fade-down animate-duration-[2000ms]">Rastreo GPS de
                    Vehículos: Control Total de tu Flotilla</h2>
                <ul class="list-none mb-6 space-y-3 animate-fade-down animate-duration-[3000ms]">
                    <li class="flex items-center mb-2">
                        ...
                        <span class="text-gray-700 tracking-wide font-light">Control Preciso de la Ubicación en Tiempo
                            Real</span>
                    </li>
                    <li class="flex items-center mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
            <img src="{{ asset('img/hero-gps.jpg') }}" alt="GPS WEB"
                class="w-full h-auto rounded-lg animate-fade-down animate-duration-[2000ms]">

        </div>
    </div>

    <section class="bg-cover bg-fixed bg-center" style="background-image: url('{{ asset('img/background-map.webp') }}')">
        <div
            ...
            <div class="w-full lg:w-5/12 mb-12 lg:mb-0">
                <div class="text-white text-xl md:text-2xl py-4 animate-bottom">EPCOM GPS </div>
                <div
                    class="bg-white rounded text-2xl md:text-3xl lg:text-4xl font-bold text-black mix-blend-screen px-10 py-5 animate-bottom">
                ...
                <div class="animate-top">
                    ...
                    <p class="mt-4 text-lg text-gray-100 font-light">El sistema de <strong class="font-normal">EPCOM
                            GPS</strong>
                        optimiza cada aspecto de tu flota, desde reducir trabajo administrativo y costos de mantenimiento
                        hasta
            ...
            <div class="w-full lg:w-6/12 grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div class="p-6 bg-white rounded-lg shadow-lg animate-right">
                ...
                <div class="p-6 bg-white rounded-lg shadow-lg animate-top">
                    <div class="flex items-center mb-4">
    ...
    <section class="bg-white">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-600 sm:text-lg">
                <h2 class="mb-4 text-2xl md:text-4xl tracking-tight font-extrabold text-gray-900 animate-bottom">
                    Rastreo de Contenedores con EPCOM GPS</h2>
                <p class="mb-4 animate-top">EPCOM GPS proporciona herramientas avanzadas para rastrear contenedores, ofreciendo
                    información en tiempo real sobre ubicación y condiciones, como temperatura y flujo de aire. Sus equipos
                    robustos y flexibles hacen de EPCOM GPS la opción ideal para una logística eficiente y competitiva.</p>
                <ul class="list-none mb-6 space-y-3 animate-top">
                    <li class="flex items-center mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye-check mr-2"
                        ...
                        <span class="text-gray-700 tracking-wide font-light capitalize">Interfaz con múltiples
                            vistas</span>
                    </li>
                    <li class="flex items-center mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-box-multiple mr-2"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <li class="flex items-center mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-photo-sensor-3 mr-2"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <span class="text-gray-700 tracking-wide font-light"> Soporte de una gran cantidad de
                            sensores</span>
                    </li>
                    <li class="flex items-center mb-2">
                        ...
                        <span class="text-gray-700 tracking-wide font-light"> Notificaciones y alarmas basadas en
                            eventos</span>
                    </li>
                </ul>
            </div>
            <div class="grid grid-cols-2 gap-4 mt-8">
                <img class="w-full rounded-lg animate-right" src="{{ asset('img/map2.webp') }}" alt=Mapa_1">
                <img class="mt-4 w-full lg:mt-10 animate-bottom" src="{{ asset('img/map1.png') }}" alt="Mapa_2">
            </div>
        </div>
    </section>
@endsection
