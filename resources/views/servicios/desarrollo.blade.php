...
<div class="bg-slate-900">
 ...
 <div class="whitespace-nowrap transition-transform duration-500 ease-in-out"
     ...
     <div class="inline-block w-full">
         <img class="object-contain object-center w-full h-96" src="{{asset('img/sistemas/clientes.jpg')}}"
             alt="" />
     </div>
     <!-- Item 2 -->
     <div class="inline-block w-full">
         <img class="object-contain object-center w-full h-96" src="{{asset('img/sistemas/catoperadores.jpg')}}"
             alt="" />
     </div>
     <!-- Item 3 -->
     <div class="inline-block w-full">
         <img class="object-contain object-center w-full h-96" src="{{asset('img/sistemas/horarios.jpg')}}"
             alt="" />
     </div>
     <!-- Item 4 -->
     <div class="inline-block w-full">
         <img class="object-contain object-center w-full h-96" src="{{asset('img/sistemas/prefacturas.jpg')}}"
             alt="" />
     </div>
 ...
 <div class="absolute bottom-0 left-0 right-0 flex justify-center space-x-2 p-4">
         ...
         <button @click="activeSlide = slideIndex" class="h-2 w-2 rounded-full"
            ...
            <div class="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
                <div class="w-full sm:w-1/2 mb-4 px-2">
                    <div class="h-full py-4 px-6 border space-y-5 border-sky-500 border-t-0 border-l-0 rounded-br-xl">
                        <h3 class="text-2xl font-bold text-md ">Clientes</h3>
                        <p class="text-sm font-bold">Administra tu base de datos de clientes de manera eficiente.</p>
                        <p class="text-sm">Nuestro módulo Clientes organiza la información en una tabla que incluye identificaciones únicas, RFC, nombres, correos electrónicos y teléfonos. Con funcionalidades adicionales como edición, visualización de detalles, generación de PDF y eliminación de registros, tendrás todo lo que necesitas para mantener tus datos actualizados y accesibles.</p>
                    </div>
                </div>
                <div class="w-full sm:w-1/2 mb-4 px-2 ">
                    <div class="h-full py-4 px-6 border space-y-5 border-sky-500 border-t-0 border-l-0 rounded-br-xl">
                        <h3 class="text-2xl font-bold text-md ">Catálogos: Operadores - Catálogo</h3>
                        <p class="text-sm font-bold"> Organiza y gestiona la información de tu personal con facilidad.</p>
                        <p class="text-sm">El submódulo Catálogo almacena todos los datos relevantes de tus operadores, incluyendo nombres, identificaciones únicas y estatus de disponibilidad. Implementa filtros para agilizar la búsqueda y mantén un control preciso con indicaciones de estatus en colores:</p>
                ...
                <div class="w-full sm:w-1/2 mb-4 px-2 ">
                    <div class="h-full py-4 px-6 border space-y-5 border-sky-500 border-t-0 border-l-0 rounded-br-xl">
                        ...
                        <p class="text-sm">El submódulo Horarios calcula automáticamente las horas de trabajo basándote en los descansos registrados y visualiza el estatus de cada registro con un sistema de semáforo:</p>
                        <ul class="list-disc list-inside ml-4 text-lg">
                ...
                <div class="w-full sm:w-1/2 mb-4 px-2 ">
                    <div class="h-full py-4 px-6 border space-y-5 border-sky-500 border-t-0 border-l-0 rounded-br-xl">
                        ...
                        <p class="text-sm">Administra de manera efectiva con opciones de edición, autorización, pago y generación de reportes en PDF y Excel. Mantén un registro detallado y preciso de los importes y estatus, asegurando un manejo eficiente de permisos y pagos.</p>
                    </div>
                </div>
    ...
    <div class="container relative flex flex-col justify-between h-full max-w-6xl px-10 mx-auto xl:px-0 mt-5">
        <h2 class="mb-1 text-3xl font-extrabold leading-tight text-slate-50">Optimiza la gestión de tu sistema con nuestros módulos especializados.</h2>
                    ...
                    <div class="relative h-full ml-0 mr-0 sm:mr-10">
                        ...
                        <div class="relative h-full p-5 bg-white border-2 border-indigo-500 rounded-lg">
                            <div class="flex items-center -mt-1">
                                <h3 class="my-2 ml-3 text-lg font-bold text-gray-800">Módulos y Secciones Personalizadas</h3>
                            </div>
                            <p class="mt-3 mb-1 text-xs font-medium text-indigo-500 uppercase">------------</p>
                            <p class="mb-2 text-gray-600">Gestión Personalizada de tus Módulos y Secciones</p>
                            <p class="mb-2 text-gray-600">Nuestro sistema ofrece una gama de módulos y secciones personalizables diseñados para adaptarse a las necesidades específicas de tu organización. A continuación, te presentamos una descripción de cada uno de ellos:</p>
                        </div>
                    </div>
                </div>
                <div class="w-full sm:w-1/2">
                    <div class="relative h-full ml-0 md:mr-10">
                        ...
                        <div class="relative h-full p-5 bg-white border-2 border-purple-500 rounded-lg">
                            ...
                            <p class="mb-2 text-gray-600">Gestiona la información de tus proveedores con eficiencia.</p>
                            <p class="mb-2 text-gray-600">Almacena y organiza datos en una tabla clara y funcional, con opciones para añadir nuevos registros, aplicar filtros de búsqueda y cambiar entre páginas. Mantén un control preciso y detallado de tus proveedores para facilitar tu gestión diaria.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="w-full mb-10 sm:mb-0 sm:w-1/2">
                    <div class="relative h-full ml-0 mr-0 sm:mr-10">
                        ...
                        <div class="relative h-full p-5 bg-white border-2 border-blue-400 rounded-lg">
                            ...
                            <p class="mb-2 text-gray-600">Clasifica y organiza los tickets por estatus, edita, elimina y consulta detalles fácilmente. Además, implementa funciones avanzadas como la generación de reportes en PDF y Excel, así como filtros de búsqueda para una gestión óptima.</p>
                        </div>
                    </div>
                </div>
                <div class="w-full mb-10 sm:mb-0 sm:w-1/2">
                    <div class="relative h-full ml-0 mr-0 sm:mr-10">
                        ...
                        <div class="relative h-full p-5 bg-white border-2 border-yellow-400 rounded-lg">
                            ...
                            <p class="mb-2 text-gray-600">El módulo Journey Management (JM) permite asignar folios únicos, registrar detalles de conductores y clientes, y controlar las horas de duración y descanso. Con funcionalidades de semáforo, generación de reportes y filtros de búsqueda, tendrás un control total sobre tus operaciones logísticas.</p>
                        </div>
                    </div>
                </div>
                <div class="w-full sm:w-1/2">
                    <div class="relative h-full ml-0 md:mr-10">
                        ...
                        <div class="relative h-full p-5 bg-white border-2 border-sky-500 rounded-lg">
                            ...
                            <p class="mb-2 text-gray-600">¡Manténte informado en todo momento! Nuestro módulo de Notificaciones te ofrece una actualización en tiempo real de los cambios en los registros del sistema. Personaliza las condiciones para recibir alertas según tus necesidades y no te pierdas ningún detalle importante, como cambios de estatus, fechas de vencimiento próximas o cierre de registros.</p>
                        </div>
                    </div>
                </div>
            </div>
