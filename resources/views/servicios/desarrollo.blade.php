...
<div class="mt-5 px-6 py-12 mx-auto flex flex-col lg:flex-row items-center justify-center lg:justify-between bg-black">
    <div>
        <section class="bg-cover bg-black">
            <div>
                <div class="text-white text-xl md:text-2xl py-4">Disponemos de las herramientas esenciales para impulsar
                    tu éxito</div>
                <div class="text-2xl text-gray-500 ">Nuestras poderosas y revolucionarias soluciones están
