...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 py-12 h-auto md:h-[100vh]">
    <div>
        <section>
            <h1 class="pb-4 text-3xl md:text-4xl lg:text-6xl mb-2 md:m-0 font-mulish-bold text-gray-800 animate-top">
                Control de Acceso
                Vehicular</h1>
            <h2 class="text-xl font-mulish-bold mb-4 text-gray-700 animate-top">En SICCOMS, ofrecemos soluciones de
                control de acceso
    ...
    <div>
        <img src="{{ asset('img/hero-vehicular1.jpg') }}" alt="Barrera vehicular"
            class="w-full h-auto rounded-lg animate-right animate-duration-[2000ms]">
    </div>
</div>
    ...
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div class="font-light text-gray-600 sm:text-lg">
            <h2 class="mb-4 text-2xl md:text-4xl tracking-tight font-mulish-bold text-gray-900 animate-top">
                Beneficios Clave</h2>
            <p class="mb-4 animate-top">Nuestros servicios ofrecen una mayor seguridad, eficiencia en el control del
                tráfico,
            ...
            <ul class="list-none mb-6 space-y-3">
                <li class="flex items-center mb-2">
                    ...
                    <span
                        class="text-gray-700 tracking-wide font-light capitalize animate-right animate-duration-[2000ms]">Aumenta
                        la Seguridad</span>
                </li>
                <li class="flex items-center mb-2">
                    ...
                    <span class="text-gray-700 tracking-wide font-light animate-right animate-duration-[2000ms]">Mejora
                        la Gestión del Tráfico</span>
                </li>
                <li class="flex items-center mb-2">
                    ...
                    <span
                        class="text-gray-700 tracking-wide font-light animate-right animate-duration-[2000ms]">Reducción
                        de Costos Operativos</span>
                </li>
                <li class="flex items-center mb-2">
                    ...
                    <span
                        class="text-gray-700 tracking-wide font-light animate-right animate-duration-[2000ms]">Confianza
                        y Tranquilidad</span>
                </li>
            </ul>
        </div>
        <div class="grid grid-cols-2 gap-4 mt-8">
            <img class="w-full rounded-lg animate-bottom animate-duration-[2000ms]"
                src="{{asset('img/content-vehicular3.jpg')}}" alt="Barreras vehiculares">
            <img class="mt-4 w-full lg:mt-10 rounded-lg animate-top animate-duration-[2000ms]"
                src="{{asset('img/content-vehicular4.jpg')}}" alt="Barreras vehiculares">
        </div>
    </div>
</section>
...
<section class="flex flex-col md:flex-row items-center bg-gray-200 overflow-hidden mx-auto px-4">
    ...
    <div class="md:w-1/2 px-6 py-16">
        <h2 class="mb-4 text-2xl md:text-4xl tracking-tight font-mulish-bold text-gray-900 animate-top">¿Quiénes Se
            Benefician de
            Nuestro Servicio?</h2>
        ...
        <ul class="list-none mb-6 space-y-3">
            <li class="flex items-center mb-2">
                ...
                <span class="text-gray-700 tracking-wide font-light animate-right animate-duration-[2000ms]">Empresas y
                    Corporaciones</span>
            </li>
            <li class="flex items-center mb-2">
                ...
                <span class="text-gray-700 tracking-wide font-light animate-right animate-duration-[2000ms]">Comunidades
                    Residenciales</span>
            </li>
            <li class="flex items-center mb-2">
                ...
                <span class="text-gray-700 tracking-wide font-light animate-right animate-duration-[2000ms]">Centros
                    Comerciales</span>
            </li>
            <li class="flex items-center mb-2">
                ...
                <span
                    class="text-gray-700 tracking-wide font-light animate-right animate-duration-[2000ms]">Instalaciones
                    Industriales</span>
            </li>
        </ul>
    </div>
