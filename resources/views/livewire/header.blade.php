    ...
    <div class="relative min-h-screen flex flex-col justify-center ">
        <div class="w-full max-w-6xl mx-auto px-4 md:px-4 py-24">
            ...
            <div class="relative text-center">
                <h1 class="font-mulish-bold py-4 inline-flex font-extrabold text-5xl md:text-6xl 2xl:text-8xl bg-clip-text text-transparent bg-[linear-gradient(to_right,theme(colors.sky.400),theme(colors.indigo.100),theme(colors.slate.300),theme(colors.sky.400),theme(colors.slate.300),theme(colors.indigo.100),theme(colors.sky.400))] bg-[length:200%_auto] animate-gradient">Sistemas Integrales En Consultoría</h1>
                <div class="max-w-3xl mx-auto mb-8">
                    <p class="text-lg 2xl:text-2xl text-slate-400">Con más de 10 años de experiencia, ofrecemos servicios integrales en consultoría, comercialización y tecnología.</p>
                </div>
