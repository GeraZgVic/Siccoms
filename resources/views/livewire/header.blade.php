<header class="w-full px-3 antialiased bg-gradient-to-br from-blue-800 via-gray-900 to-blue-700 lg:px-6">


    <div class="mx-auto max-w-7xl">
        <nav class="flex items-center w-full h-24 select-none" x-data="{ showMenu: false }">
            <div
                class="relative flex flex-wrap items-start justify-between w-full mx-auto font-medium md:items-center md:h-24 md:justify-between animate-fade animate-once animate-duration-[600ms] animate-delay-200 animate-ease-in animate-normal">
                <a href="#_"
                    class="flex items-center w-1/4 py-4 pl-6 pr-4 space-x-2 font-extrabold text-white md:py-0">
                    {{-- <img src="{{asset('img/logo-siccoms.jpg')}}" alt="Logo Siccoms"> --}}
                    <span class="text-2xl animate-fade animate-once animate-duration-[600ms] animate-delay-200 animate-ease-in animate-normal">SICCOMS </span>
                </a>
                <div :class="{ 'flex': showMenu, 'hidden md:flex': !showMenu }"
                    class="absolute z-50 flex-col items-center justify-center w-full h-auto px-2 text-center text-gray-400 -translate-x-1/2 border-0 border-gray-600 rounded-full md:border md:w-auto md:h-10 left-1/2 md:flex-row md:items-center">
                    <a href="#"
                ...
                <div class="fixed top-0 left-0 z-40 items-center hidden w-full h-full p-3 text-sm bg-blue-900 bg-opacity-60 md:w-auto md:bg-transparent md:p-0 md:relative md:flex"
