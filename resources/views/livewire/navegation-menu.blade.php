<nav class="flex items-center w-full lg:h-16 select-none navegacion" x-data="{ showMenu: false }">
    <div class="relative flex w-full mx-auto font-medium lg:items-center lg:justify-between">
        {{-- LOGO --}}
        <a href="{{ route('home') }}"
            class="flex items-center py-4 pl-6 pr-4 font-extrabold lg:py-0 transition-transform duration-300 ease-in-out transform hover:scale-105 focus:scale-105">
                    ...
                    <div class="flex flex-col lg:flex-row w-full lg:w-[50rem] h-auto lg:h-[19rem] z-50">
                        ...
                        <div class="w-full h-full lg:w-1/3 flex flex-col lg:justify-between lg:pt-4">
                            <div class="flex flex-col justify-around items-end">
                                ...
                                <button @click="openTab = 1" :class="openTab === 1 ? 'bg-gray-600' : ''"
                                    class="w-full text-sm lg:w-2/3 lg:rounded-l-md px-4 py-2 text-gray-200 hover:text-gray-400">
                                    Ingeniería TI
                                </button>
                        ...
                        <div class="w-full h-auto  p-4 bg-slate-900 lg:pt-4">
                            ...
                            <div x-show="openTab === 1" class="space-y-2">
                                <span class="text-sm my-3 font-mulish-bold">Ingeniería en Tecnologías de
                                    Información</span>
                                <ul class="space-y-3 text-center">
                                    <div class="text-center grid lg:grid-cols-2 gap-2 mt-2 lg:mt-0 ">
                                        ...
                                        <a href="{{route('servicios.ups')}}" class="flex gap-2 items-center">
                                            <span class="bg-slate-600 p-2 rounded-md">
                            ...
                            <div x-show="openTab === 3" class="space-y-2">
                                ...
                                <div class="text-center grid lg:grid-cols-2 gap-2 mt-2 lg:mt-0 ">
                                    <a href="{{route('servicios.consultoria')}}" class="flex gap-2 items-center">
                                        <span class="bg-slate-600 p-2 rounded-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="size-6">
