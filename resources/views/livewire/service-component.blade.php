<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    @foreach ($serviciosTI as $servicio)
        <div class="max-w-sm w-full lg:max-w-full lg:flex mb-4 transition duration-300 ease-in-out hover:shadow-lg hover:shadow-blue-600/40">
            <div class="h-48 lg:h-auto md:h-64 lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
                <img class="object-cover w-full h-full object-center" src="{{ $servicio['imagen'] }}" alt="Service Image">
            </div>
            <div class="border border-gray-400 rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-center leading-normal w-full">
                <div class="mb-8">
