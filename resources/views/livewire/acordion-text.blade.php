    ...
    <div x-data="{ id: $id('accordion') }" class="cursor-pointer group">
        ...
        <div x-show="activeAccordion==id" x-collapse x-cloak>
            <div class="p-4 pt-0 text-gray-700">
                Acertar en nuevas formas de resolver las necesidades de nuestros clientes, con tecnología de vanguardia disponible.
            </div>
        </div>
    </div>
    <div x-data="{ id: $id('accordion') }" class="cursor-pointer group">
        ...
        <div x-show="activeAccordion==id" x-collapse x-cloak>
            <div class="p-4 pt-0 text-gray-700">
                Ser el aliado tecnológico de confianza elegido para innovar las necesidades de las personas y empresas.
            </div>
        </div>
    </div>
