            ...
            <div class="md:flex-shrink-0 md:w-64 mx-auto text-center md:mx-0 md:text-left mb-4 md:mb-0">
                ...
                <div class="mt-4">
                    <span class="inline-flex justify-center mt-2 md:ml-auto md:mt-0 md:justify-start">
                        ...
                        <a
                            class="ml-3 text-gray-600 cursor-pointer hover:text-blue-700 hover:transition hover:duration-300 hover:scale-125">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                class="w-8 h-8" viewBox="0 0 24 24">
                                <path
            ...
            <div
                ...
                <div class="w-full px-4 lg:w-1/3 md:w-1/2">
                    <h2 class="mb-3 text-lg font-medium tracking-widest text-gray-900 uppercase relative inline-block">
                        Sobre nosotros
                        <span class="absolute bottom-0 left-0 h-1 w-full inline-block bg-blue-600 rounded"></span>
                    </h2>
                    <ul class="list-none">
                        <li class="mt-3">
                ...
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    <h2 class="mb-3 text-lg font-medium tracking-widest text-gray-900 uppercase relative inline-block">
                        Asociados
                        <span class="absolute bottom-0 left-0 h-1 w-full bg-blue-600 rounded"></span>
                    </h2>
                    <ul class="list-none">
                        <li class="mt-3">
                        ...
                        <li class="mt-3">
                            <a class="text-gray-700 cursor-pointer hover:text-blue-900"
                                href="https://m.facebook.com/GrupoVillas.Arq?_rdr" target="_blank">Grupo Villas</a>
                        </li>
                        <li class="mt-3">
                            <a class="text-gray-700 cursor-pointer hover:text-blue-900"
                                href="https://www.capitallera.com/" target="_blank">Capital Lera</a>
                        </li>
                        <li class="mt-3">
                            <a class="text-gray-700 cursor-pointer hover:text-blue-900"
