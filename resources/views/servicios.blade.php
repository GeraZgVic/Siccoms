    ...
    <div class="container mx-auto px-4 py-24 md:py-32 relative z-10">
        <div class="flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="w-full md:w-1/2 mb-12 md:mb-0">
                <h1
                    class="animate-fade-down mt-4 md:mt-0 block text-3xl font-bold text-gray-50 sm:text-4xl lg:text-5xl lg:leadin font-mug-tightlish-bold mb-4">
                    Nuestros Servicios
                </h1>
            ...
            <div class="w-full md:w-1/2 md:pl-12">
                <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-2xl">
                    <img class="object-cover h-8 lg:h-10 w-auto" src="{{ asset('img/lg-siccoms.png') }}"
                        alt="Logo Siccoms">
        ...
        <div class="py-4 px-2 mx-auto max-w-screen-xl sm:py-4 lg:px-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-gray-200 h-auto md:h-full flex flex-col">
                    <a href="#"
                        class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
                        <img src="{{ asset('img/servicios/consultoria.jpg') }}" alt=""
                            class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                ...
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-gray-200">
                    <a href="{{route('servicios.desarrollo')}}"
                        class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 mb-4">
                        <img src="{{ asset('img/servicios/software.jpg') }}" alt=""
                            class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/50 to-gray-900/5"></div>
                        <h3
                            class="z-10 text-2xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl md:text-3xl">
                    ...
                    <a href="{{route('servicios.desarrollo')}}"
                        ...
                        <img src="{{ asset('img/servicios/web.jpg') }}" alt=""
                            class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/50 to-gray-900/5"></div>
                        <h3
                            class="z-10 text-2xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl md:text-3xl">
